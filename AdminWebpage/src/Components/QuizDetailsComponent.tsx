...
import App/*, { type JSONQuizDetails }*/ from "../App";
        ...
        return (
            <table style={{ width: '80%', maxWidth: '1200px' }} className="centered">
                <thead>
                    <tr>
                        <td style={{ width: 'auto' }}>
                            <span id="testGroupName" style={{ padding: '0px 5px', fontSize: '1.5rem', fontWeight: 'bold' }}>{this.state.quiz?.name ?? "Csapatnév"}</span>
                        </td>
                        <td style={{ padding: '5px 5px', width: '0px', textAlign: 'center' }}>
                            <span id="testLang" style={{ padding: '0px 5px', fontSize: '1.5rem', fontWeight: 'bold' }}>{this.state.quiz?.language.toUpperCase() ?? "Nyelv"}</span>
                        </td>
                        <td style={{ padding: '5px 5px', width: '150px', textAlign: 'center', whiteSpace: 'nowrap' }}>
                            <span id="testScore" style={{ fontSize: '1.8rem', fontWeight: 'bold' }}>{this.state.quiz?.score ?? "??"} / {this.state.quiz ? Object.values(this.state.quiz.questions).length : "??"}</span>
                        </td>
                    </tr>
                </thead>
                <tbody>
