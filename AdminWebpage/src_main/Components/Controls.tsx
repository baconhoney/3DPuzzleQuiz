...
import { ConfirmPopupComponent } from "./Controllers";
    ...
    render() {
        return (
            <>
                ...
                <ConfirmPopupComponent ref={this.confirmSendPhasePopupRef} text={"Biztosan kvíz fázist vált?\nA következő fázisváltás várható ideje " + getHHMMFromDate(this.state.nextPhaseChangeAt) + " lesz."}
                    onConfirm={() => { actions.sendNextPhase(this.state.phase, this.state.nextPhaseChangeAt); }} onCancel={() => { }} />
